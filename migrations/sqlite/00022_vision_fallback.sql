-- migrations/sqlite/00022_vision_fallback.sql
--
-- SQLite mirror of migrations/postgres/00022_vision_fallback.sql (INTEGER
-- stands in for BOOLEAN, as SQLite has no native boolean type).
--
...
-- +goose Up
ALTER TABLE models ADD COLUMN supports_image_input INTEGER NULL;
...
ALTER TABLE models DROP COLUMN supports_image_input;
ALTER TABLE request_logs DROP COLUMN source;
ALTER TABLE request_logs DROP COLUMN parent_request_id;
