-- migrations/postgres/00020_request_logs_facts_json.sql
--
...
ALTER TABLE request_logs
    ADD COLUMN IF NOT EXISTS facts_json TEXT NOT NULL DEFAULT '';  -- JSON array of observations with no dedicated column; '' when every one was recognised

-- +goose Down
ALTER TABLE request_logs DROP COLUMN IF EXISTS facts_json;
