...
func classifyCapabilityResult(result TestResult) *bool {
...
func (s *ModelService) runCapabilityTest(ctx context.Context, proto protocols.ProtocolID, testType, baseURL, apiKey, providerModelName string) (TestResult, error) {
	...
	default:
		return TestResult{}, fmt.Errorf("unknown capability test_type %q", testType)
	}
}
...
func (s *ModelService) runCandidateProbes(ctx context.Context, proto protocols.ProtocolID, baseURL, apiKey, providerModelName string) (CandidateTestReport, error) {
	...
	basicPassed := basic.Outcome == TestSuccess
...
func (s *ModelService) runOneCapabilityProbe(ctx context.Context, testType string, proto protocols.ProtocolID, baseURL, apiKey, providerModelName string) ProbeReport {
	...
	if err != nil {
		...
		// ProviderClient owns its own pool of providerClientConcurrency slots, so
